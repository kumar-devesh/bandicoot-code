...
TEMPLATE_TEST_CASE("find_nonfinite_basic", "[find_nonfinite]", double, float)
  {
  typedef TestType eT;
  ...
  uvec y3 = find_nonfinite(x, 0, "first");
  uvec y4 = find_nonfinite(x, 0, "last");
...
TEMPLATE_TEST_CASE("find_nonfinite_basic_2", "[find_nonfinite]", double, float)
  ...
  x(53) = std::numeric_limits<eT>::quiet_NaN();
  x(77) = std::numeric_limits<eT>::infinity();
...
TEMPLATE_TEST_CASE("find_nonfinite_10", "[find_nonfinite]", double, float)
  ...
  x(11) = std::numeric_limits<eT>::infinity();
  x(93) = std::numeric_limits<eT>::infinity();
  x(110) = std::numeric_limits<eT>::infinity();
  x(112) = std::numeric_limits<eT>::infinity();
...
TEMPLATE_TEST_CASE("top_5_nonfinite_values", "[find_nonfinite]", double, float)
  {
  typedef TestType eT;
  ...
  uvec y1 = find_nonfinite(x, 5);
  uvec y2 = find_nonfinite(x, 5, "first");
...
TEMPLATE_TEST_CASE("bottom_5_nonfinite_values", "[find_nonfinite]", double, float)
  {
  typedef TestType eT;
  ...
  uvec y = find_nonfinite(x, 5, "last");
...
TEMPLATE_TEST_CASE("find_nonfinite_all_nonfinite", "[find_nonfinite]", double, float)
  {
  typedef TestType eT;
...
TEST_CASE("col_major_find_nonfinite", "[find_nonfinite]")
  ...
  uvec y3 = find_nonfinite(x, 0, "first");
  uvec y4 = find_nonfinite(x, 0, "last");
  uvec y5 = find_nonfinite(x, 2);
  uvec y6 = find_nonfinite(x, 2, "first");
  uvec y7 = find_nonfinite(x, 2, "last");
...
TEMPLATE_TEST_CASE("find_nonfinite_k_greater_than_nonzeros", "[find_nonfinite]", double, float)
  {
  typedef TestType eT;
  ...
  for (uword i = 0; i < 500; ++i)
    {
    x[10 * i] = std::numeric_limits<eT>::infinity();
    }

  uvec y1 = find_nonfinite(x, 600);
  uvec y2 = find_nonfinite(x, 600, "first");
  uvec y3 = find_nonfinite(x, 600, "last");
...
TEMPLATE_TEST_CASE("find_nonfinite_inside_expression", "[find_nonfinite]", double, float)
  ...
  uvec y_ref = find_nonfinite(x);

  umat y1 = repmat(find_nonfinite(x), 2, 3);
  umat y2 = repmat(find_nonfinite(x, 0), 2, 3);
  umat y3 = repmat(find_nonfinite(x, 0, "first"), 2, 3);
  umat y4 = repmat(find_nonfinite(x, 0, "last"), 2, 3);
...
// find in find
TEMPLATE_TEST_CASE("find_nonfinite_inside_find_nonfinite", "[find_nonfinite]", double, float)
  {
  typedef TestType eT;
  ...
  uvec z_ref = find_nonfinite(x, 10, "first");

  uvec y1 = find_nonfinite(find_nonfinite(x, 10, "first"));
  uvec y2 = find_nonfinite(find_nonfinite(x, 10, "first"), 0);
  uvec y3 = find_nonfinite(find_nonfinite(x, 10, "first"), 0, "first");
  uvec y4 = find_nonfinite(find_nonfinite(x, 10, "first"), 0, "last");

  uvec y_ref = find_nonfinite(z_ref);
...
TEST_CASE("find_nonfinite_invalid_direction", "[find_finite]")
  ...
  REQUIRE_THROWS( y = find_nonfinite(x, 0, "hello") );
  REQUIRE_THROWS( y = find_nonfinite(x, 0, "goodbye") );
  REQUIRE_THROWS( y = find_nonfinite(x, 0, "1") );
  REQUIRE_THROWS( y = find_nonfinite(x, 0, "") );
