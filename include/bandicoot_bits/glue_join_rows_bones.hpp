...
struct glue_join_rows
  ...
  template<typename eT, typename T1, typename T2, typename T3>              static inline void apply(Mat<eT>& out, const T1& A, const T2& B, const T3& C);
  template<typename eT, typename T1, typename T2, typename T3, typename T4> static inline void apply(Mat<eT>& out, const T1& A, const T2& B, const T3& C, const T4& D);
