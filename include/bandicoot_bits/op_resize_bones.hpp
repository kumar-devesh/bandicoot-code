...
class op_resize
  ...
  template<typename out_eT, typename T1> inline static void apply(Mat<out_eT>& out, const Op<T1, op_resize>& in);

  template<typename out_eT, typename T1> inline static void apply(Mat<out_eT>& out, const Op<mtOp<out_eT, T1, mtop_conv_to>, op_resize>& in);
