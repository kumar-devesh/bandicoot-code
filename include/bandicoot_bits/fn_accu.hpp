...
accu(const Base<typename T1::elem_type, T1>& X)
  ...
  opencl::runtime_t::adapt_uword dev_chunk_size(chunk_size);
  opencl::runtime_t::adapt_uword dev_n_chunks  (n_chunks  );
  ...
  opencl::runtime_t::adapt_uword dev_A_len  (A.n_elem);
...
accu(const subview<eT>& S)
  ...
  opencl::runtime_t::adapt_uword S_m_n_rows(S.m.n_rows);
  
  opencl::runtime_t::adapt_uword start_row(S.aux_row1);
  opencl::runtime_t::adapt_uword start_col(S.aux_col1);
  
  opencl::runtime_t::adapt_uword S_n_rows(S.n_rows);
  opencl::runtime_t::adapt_uword S_n_cols(S.n_cols);
