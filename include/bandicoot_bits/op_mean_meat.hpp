...
inline
void
op_mean::apply_direct(Mat<out_eT>& out, const Mat<in_eT>& in, const uword dim)
  {
  coot_extra_debug_sigprint();
  ...
  coot_rt_t::mean(out.get_dev_mem(false), in.get_dev_mem(false), in.n_rows, in.n_cols, dim);
  }
