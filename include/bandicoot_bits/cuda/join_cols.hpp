...
join_cols(dev_mem_t<eT> out, const dev_mem_t<eT> A, const uword A_n_rows, const uword A_n_cols, const dev_mem_t<eT> B, const uword B_n_rows, const uword B_n_cols, const dev_mem_t<eT> C, const uword C_n_rows, const uword C_n_cols, const dev_mem_t<eT> D, const uword D_n_rows, const uword D_n_cols)
  ...
  if (A_n_elem > 0)
    {
    result = coot_wrapper(cudaMemcpy2D)((void*) out.cuda_mem_ptr,
  ...
  if (B_n_elem > 0)
    {
    result = coot_wrapper(cudaMemcpy2D)((void*) (out.cuda_mem_ptr + A_n_rows),
                                        out_n_rows * sizeof(eT),
                                        (void*) B.cuda_mem_ptr,
                                        B_n_rows * sizeof(eT),
                                        B_n_rows * sizeof(eT),
  ...
  if (C_n_elem > 0)
    {
    result = coot_wrapper(cudaMemcpy2D)((void*) (out.cuda_mem_ptr + A_n_rows + B_n_rows),
                                        out_n_rows * sizeof(eT),
                                        (void*) C.cuda_mem_ptr,
                                        C_n_rows * sizeof(eT),
                                        C_n_rows * sizeof(eT),
  ...
  if (D_n_elem > 0)
    {
    result = coot_wrapper(cudaMemcpy2D)((void*) (out.cuda_mem_ptr + A_n_rows + B_n_rows + C_n_rows),
                                        out_n_rows * sizeof(eT),
                                        (void*) D.cuda_mem_ptr,
                                        D_n_rows * sizeof(eT),
                                        D_n_rows * sizeof(eT),
