...
min_colwise(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  CUfunction kernel = get_rt().cuda_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::min_colwise_conv_post : twoway_kernel_id::min_colwise_conv_pre);
  ...
  coot_check_cuda_error(result, "coot::cuda::min_colwise(): cuLaunchKernel() failed");
  }
...
min_rowwise(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  CUfunction kernel = get_rt().cuda_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::min_rowwise_conv_post : twoway_kernel_id::min_rowwise_conv_pre);
  ...
  coot_check_cuda_error(result, "coot::cuda::min_rowwise(): cuLaunchKernel() failed");
  }
...
min_colwise_subview(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword M_n_rows, const uword start_row, const uword start_col, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  CUfunction kernel = get_rt().cuda_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::submat_min_colwise_conv_post : twoway_kernel_id::submat_min_colwise_conv_pre);
  ...
  coot_check_cuda_error(result, "coot::cuda::min_colwise_subview(): cuLaunchKernel() failed");
  }
...
min_rowwise_subview(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword M_n_rows, const uword start_row, const uword start_col, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  CUfunction kernel = get_rt().cuda_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::submat_min_rowwise_conv_post : twoway_kernel_id::submat_min_rowwise_conv_pre);
  ...
  coot_check_cuda_error(result, "coot::cuda::min_rowwise_subview(): cuLaunchKernel() failed");
  }
