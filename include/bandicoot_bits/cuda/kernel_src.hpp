...
get_cuda_oneway_kernel_src()
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,accu_chunked)(eT1* out, const eT1* A, const UWORD chunk_size, const UWORD n_chunks) \n"
  "  { \n"
  "  const UWORD chunk_id = blockIdx.x * blockDim.x + threadIdx.x; \n"
  "  if(chunk_id < n_chunks) \n"
  "    { \n"
  "    const eT1* ptr = &(A[ chunk_id * chunk_size ]); \n"
  "    eT1 acc = (eT1)(0); \n" // runtime unrolling is not supported by CUDA
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,accu_twostage)(eT1* out, const UWORD out_len, const eT1* A, const UWORD A_start, const UWORD A_len) \n"
  "  { \n"
  "  const UWORD id = blockIdx.x * blockDim.x + threadIdx.x; \n"
  "  if(id == 0) \n"
  "    { \n"
...
get_cuda_twoway_kernel_src()
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,equ_array_neg)(eT2* out, const eT1* A, const eT1 val_pre, const eT2 val_post, const UWORD N) \n"
  "  { \n"
  "  (void)(val_pre); \n"
  "  (void)(val_post); \n"
  "  const UWORD i = blockIdx.x * blockDim.x + threadIdx.x; \n"
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,equ_array_minus_scalar_pre)(eT2* out, const eT1* A, const eT1 val_pre, const eT2 val_post, const UWORD N) \n"
  "  { \n"
  "  const UWORD i = blockIdx.x * blockDim.x + threadIdx.x; \n"
  "  if(i < N)\n"
  "    {\n"
  "    out[i] = val_post - ((eT2) (A[i] - val_pre));\n"
  "    }\n"
  "  } \n"
  "\n"
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,equ_array_square)(eT2* out, const eT1* A, const eT1 val_pre, const eT2 val_post, const UWORD N) \n"
  "  { \n"
  "  (void)(val_pre); \n"
  "  (void)(val_post); \n"
  "  const UWORD i = blockIdx.x * blockDim.x + threadIdx.x; \n"
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,equ_array_sqrt)(eT2* out, const eT1* A, const eT1 val_pre, const eT2 val_post, const UWORD N) \n"
  "  { \n"
  "  (void)(val_pre); \n"
  "  (void)(val_post); \n"
  "  const UWORD i = blockIdx.x * blockDim.x + threadIdx.x; \n"
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,equ_array_exp)(eT2* out, const eT1* A, const eT1 val_pre, const eT2 val_post, const UWORD N) \n"
  "  { \n"
  "  (void)(val_pre); \n"
  "  (void)(val_post); \n"
  "  const UWORD i = blockIdx.x * blockDim.x + threadIdx.x; \n"
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,equ_array_log)(eT2* out, const eT1* A, const eT1 val_pre, const eT2 val_post, const UWORD N) \n"
  "  { \n"
  "  (void)(val_pre); \n"
  "  (void)(val_post); \n"
  "  const UWORD i = blockIdx.x * blockDim.x + threadIdx.x; \n"
  ...
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,dot_chunked)(twoway_promoted_eT* out, const eT1* A, const eT2* B, const UWORD chunk_size, const UWORD n_chunks) \n"
  "  { \n" // use a chunked approach like accu_chunked
  "  const UWORD chunk_id = blockIdx.x * blockDim.x + threadIdx.x; \n"
  "  if(chunk_id < n_chunks) \n"
  "    { \n"
  "    const eT1* ptrA = &(A[ chunk_id * chunk_size ]); \n"
  "    const eT2* ptrB = &(B[ chunk_id * chunk_size ]); \n"
  "    out[chunk_id] = (twoway_promoted_eT) (0);\n"
  "    for (UWORD i = 0; i < chunk_size; ++i) \n"
  "      {\n"
  "      const twoway_promoted_eT A_val = (twoway_promoted_eT) (ptrA[i]);\n"
  "      const twoway_promoted_eT B_val = (twoway_promoted_eT) (ptrB[i]);\n"
  "      out[chunk_id] += A_val * B_val;\n"
  "      }\n"
  "    } \n"
  "  } \n"
  "\n"
  "__global__ void COOT_FN(PREFIX,dot_twostage)(twoway_promoted_eT* out, const UWORD out_len, const eT1* A, const eT2* B, const UWORD A_start, const UWORD A_len) \n"
  "  { \n"
  "  const UWORD id = blockIdx.x * blockDim.x + threadIdx.x; \n"
  "  if(id == 0) \n"
  "    { \n"
