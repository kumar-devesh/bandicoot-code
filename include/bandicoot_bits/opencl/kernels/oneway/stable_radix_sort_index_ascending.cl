...
COOT_FN(PREFIX,stable_radix_sort_index_ascending)(__global eT1* A,
  ...
  for (UWORD b = 0; b < 8 * sizeof(eT1) - 1; ++b)
    ...
    local_counts[0] = 0; // holds the count of elements with bit value 0 and sign value 0
    local_counts[1] = 0; // holds the count of elements with bit value 1 and sign value 0
