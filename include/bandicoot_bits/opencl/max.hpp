...
max_colwise(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  coot_debug_check( (get_rt().cl_rt.is_valid() == false), "coot::opencl::max_colwise(): OpenCL runtime not valid" );

  runtime_t::cq_guard guard;

  cl_kernel kernel = get_rt().cl_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::max_colwise_conv_post : twoway_kernel_id::max_colwise_conv_pre);
  ...
  coot_check_cl_error(status, "coot::opencl::max_colwise(): failed to run kernel");
  }
...
max_rowwise(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  coot_debug_check( (get_rt().cl_rt.is_valid() == false), "coot::opencl::max_rowwise(): OpenCL runtime not valid" );

  runtime_t::cq_guard guard;

  cl_kernel kernel = get_rt().cl_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::max_rowwise_conv_post : twoway_kernel_id::max_rowwise_conv_pre);
  ...
  coot_check_cl_error(status, "coot::opencl::max_rowwise(): failed to run kernel");
  }
...
max_colwise_subview(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword M_n_rows, const uword start_row, const uword start_col, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  coot_debug_check( (get_rt().cl_rt.is_valid() == false), "coot::opencl::max_colwise_subview(): OpenCL runtime not valid" );

  runtime_t::cq_guard guard;

  cl_kernel k1 = get_rt().cl_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::submat_max_colwise_conv_post : twoway_kernel_id::submat_max_colwise_conv_pre);
  ...
  coot_check_cl_error(status, "coot::opencl::max_colwise_subview(): failed to run kernel");
  }
...
max_rowwise_subview(dev_mem_t<eT2> out, const dev_mem_t<eT1> A, const uword M_n_rows, const uword start_row, const uword start_col, const uword n_rows, const uword n_cols, const bool post_conv_apply)
  ...
  coot_debug_check( (get_rt().cl_rt.is_valid() == false), "coot::opencl::max_rowwise_subview(): OpenCL runtime not valid" );

  runtime_t::cq_guard guard;

  cl_kernel k1 = get_rt().cl_rt.get_kernel<eT2, eT1>(post_conv_apply ? twoway_kernel_id::submat_max_rowwise_conv_post : twoway_kernel_id::submat_max_rowwise_conv_pre);
  ...
  coot_check_cl_error(status, "coot::opencl::max_rowwise_subview(): failed to run kernel");
  }
