...
kernel_src::init_source()
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,dot_chunked)(__global eT* out, __global const eT* A, __global const eT* B, const UWORD chunk_size, const UWORD n_chunks) \n"
  "  { \n"
  "  const UWORD chunk_id = get_global_id(0); \n"
  "  if(chunk_id < n_chunks) \n"
  "    { \n"
  "    __global const eT* ptr1 = &(A[ chunk_id * chunk_size ]); \n"
  "    __global const eT* ptr2 = &(B[ chunk_id * chunk_size ]); \n"
  "    eT dot = (eT)(0); \n"
  "    #pragma unroll \n"
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,dot_twostage)(__global eT* out, const UWORD out_len, __global const eT* A, __global const eT* B, const UWORD A_start, const UWORD A_len) \n"
  "  { \n"
  "  const UWORD id = get_global_id(0); \n"
  "  if(id == 0) \n"
  "    { \n"
