...
kernel_src::init_oneway_source()
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,min)(__global const eT1* in_mem, const UWORD n_elem, __global eT1* out_mem, __local volatile eT1* aux_mem) \n"
  "  { \n"
  "  const UWORD tid = get_local_id(0); \n"
  "  UWORD i = get_group_id(0) * (get_local_size(0) * 2) + tid; \n"
  "  const UWORD grid_size = get_local_size(0) * 2 * get_num_groups(0); \n"
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,min_small)(__global const eT1* in_mem, const UWORD n_elem, __global eT1* out_mem, __local volatile eT1* aux_mem) \n"
  "  { \n"
  "  const UWORD tid = get_local_id(0); \n"
  "  UWORD i = get_group_id(0) * (get_local_size(0) * 2) + tid; \n"
  "  const UWORD grid_size = get_local_size(0) * 2 * get_num_groups(0); \n"
  ...
  "    } \n"
  "  } \n"
  "void COOT_FN(PREFIX,max_wavefront_reduce_other)(__local volatile eT1* data, UWORD tid) \n"
  "  { \n"
  "  for(UWORD i = WAVEFRONT_SIZE; i > 0; i >>= 1) \n"
  "    { \n"
  "    if (tid < i) \n"
  ...
  "  } \n"
  "\n"
  "void COOT_FN(PREFIX,max_wavefront_reduce_8)(__local volatile eT1* data, UWORD tid) \n"
  "  { \n"
  ...
  "  } \n"
  "\n"
  "void COOT_FN(PREFIX,max_wavefront_reduce_16)(__local volatile eT1* data, UWORD tid) \n"
  "  { \n"
  ...
  "  } \n"
  "\n"
  "void COOT_FN(PREFIX,max_wavefront_reduce_32)(__local volatile eT1* data, UWORD tid) \n"
  "  { \n"
  ...
  "  } \n"
  "\n"
  "void COOT_FN(PREFIX,max_wavefront_reduce_64)(__local volatile eT1* data, UWORD tid) \n"
  "  { \n"
  ...
  "  } \n"
  "\n"
  "void COOT_FN(PREFIX,max_wavefront_reduce_128)(__local volatile eT1* data, UWORD tid) \n"
  "  { \n"
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,max)(__global const eT1* in_mem, const UWORD n_elem, __global eT1* out_mem, __local volatile eT1* aux_mem) \n"
  "  { \n"
  "  const UWORD tid = get_local_id(0); \n"
  "  UWORD i = get_group_id(0) * (get_local_size(0) * 2) + tid; \n"
  "  const UWORD grid_size = get_local_size(0) * 2 * get_num_groups(0); \n"
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,max_small)(__global const eT1* in_mem, const UWORD n_elem, __global eT1* out_mem, __local volatile eT1* aux_mem) \n"
  "  { \n"
  "  const UWORD tid = get_local_id(0); \n"
  "  UWORD i = get_group_id(0) * (get_local_size(0) * 2) + tid; \n"
  "  const UWORD grid_size = get_local_size(0) * 2 * get_num_groups(0); \n"
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,max_abs)(__global const eT1* in_mem, const UWORD n_elem, __global eT1* out_mem, __local volatile eT1* aux_mem) \n"
  "  { \n"
  "  const UWORD tid = get_local_id(0); \n"
  "  UWORD i = get_group_id(0) * (get_local_size(0) * 2) + tid; \n"
  "  const UWORD grid_size = get_local_size(0) * 2 * get_num_groups(0); \n"
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,max_abs_small)(__global const eT1* in_mem, const UWORD n_elem, __global eT1* out_mem, __local volatile eT1* aux_mem) \n"
  "  { \n"
  "  const UWORD tid = get_local_id(0); \n"
  "  UWORD i = get_group_id(0) * (get_local_size(0) * 2) + tid; \n"
  "  const UWORD grid_size = get_local_size(0) * 2 * get_num_groups(0); \n"
...
kernel_src::init_twoway_source()
  ...
  "  } \n"
  "\n"
  "__kernel void COOT_FN(PREFIX,equ_array_abs)(__global eT2* out, __global const eT1* A, const eT1 val_pre, const eT2 val_post, const UWORD N) \n"
  "  { \n"
  "  (void)(val_pre); \n"
  "  (void)(val_post); \n"
  "  const UWORD i = get_global_id(0); \n"
