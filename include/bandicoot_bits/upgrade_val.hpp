...
struct upgrade_val<T,T>
  ...
  coot_inline static const T& apply(const T& x) { return x; }
  };
...
struct upgrade_val< std::complex<T>, T2 >
  ...
  coot_inline static const std::complex<T>& apply(const std::complex<T>& x) { return x;    }
  coot_inline static       T                apply(const T2 x)               { return T(x); }
  };
...
struct upgrade_val< T1, std::complex<T> >
  ...
  coot_inline static       T                apply(const T1 x)               { return T(x); }
  coot_inline static const std::complex<T>& apply(const std::complex<T>& x) { return x;    }
  };
...
struct upgrade_val< std::complex<float>, double >
  ...
  coot_inline static const std::complex<double> apply(const std::complex<float>& x) { return std::complex<double>(x); }
  coot_inline static       double               apply(const double x)               { return x; }
  };
...
struct upgrade_val< std::complex<float>, std::complex<double> >
  ...
  coot_inline static const std::complex<double>  apply(const std::complex<float>&  x) { return std::complex<double>(x); }
  coot_inline static const std::complex<double>& apply(const std::complex<double>& x) { return x; }
  };
...
struct upgrade_val< std::complex<double>, float >
  ...
  coot_inline static const std::complex<double>& apply(const std::complex<double>& x) { return x; }
  coot_inline static       double                apply(const float x)                 { return double(x); }
  };
