...
inline
uword
glue_cor::compute_n_rows(const Glue<T1, T2, glue_cor>& glue, const uword A_n_rows, const uword A_n_cols, const uword B_n_rows, const uword B_n_cols)
  {
  coot_ignore(glue);
...
inline
uword
glue_cor::compute_n_cols(const Glue<T1, T2, glue_cor>& glue, const uword A_n_rows, const uword A_n_cols, const uword B_n_rows, const uword B_n_cols)
  {
  coot_ignore(glue);
